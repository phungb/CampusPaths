...
public class HW5TestDriver {
    ...
    private final Map<String, DGraph<String,String>> graphs = new HashMap<String, DGraph<String,String>>();
    ...
    private void createGraph(String graphName) {
    	...
    	DGraph<String,String> graph = new DGraph<String,String>();
    ...
    private void addNode(String graphName, String nodeName) {
        // Insert your code here.
         ...
         DGraph<String,String> graph = graphs.get(graphName);
    ...
    private void listNodes(String graphName) {
        ...
        DGraph<String,String> graph = graphs.get(graphName);
        Set<String> nodes = new TreeSet<String>(graph.getNodes());
        
        String allNodes = graphName + " contains:";
        for(String node : nodes) {
        	allNodes += " " + node;
        }
        output.println(allNodes);
    }
    ...
    private void listChildren(String graphName, String parentName) {
        // Insert your code here.
    	String children = "the children of " + parentName + " in " + graphName + " are:";
        DGraph<String,String> graph = graphs.get(graphName);
        Set<String> nodes = new TreeSet<String>(graph.getChildren(parentName));
        
        for(String node: nodes) {
        	for(String label : graph.getLabel(parentName, node)) {
        		children += " " + node + "(" + label + ")";
        	}
        }
